/*
=
Argenis Villasmil  ci:13080898   universidad Dr. Jose Gregorio Hernández
*/
...
public class Chat {
	...
	hm.put(nickname, session);
        ...
        //deja enviar a usuarios existentes.
    ...
    public void onError(Throwable t) throws Throwable {
       System.out.println("Error de chat: " + t.toString());
    }
    ...
    private static void broadcast_all(JsonObject  msg) {
        for (Chat client : connections) {
            try {
                ...
                System.out.println("Error: No se pudo enviar el mensaje"+ e);
